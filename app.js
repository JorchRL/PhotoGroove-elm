			...
			[
				...
				_List_fromArray(
					[
						...
						function (a) {
							return $author$project$PhotoGroove$ClickedSize(size);
						})
					]),
				_List_Nil),
				$elm$html$Html$text(
...
var $author$project$PhotoGroove$viewThumnail = F2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$PhotoGroove$viewThumnail(model.selectedUrl),
					model.photos)),
				A2(
				$elm$html$Html$img,
				_List_fromArray(
